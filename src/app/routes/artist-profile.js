...
module.exports = (app, passport) => {
    ...
    app.get('/artist-profile',helpers.isLogged, (req, res) => {
        ...
        res.render('artist/artist-profile',{
...
app.post('/updateInfoPersonalArtist',uploadImages.single('image_ar'),helpers.isLogged, (req, res) => {
...
app.post('/updateInfoPaymentsArtist',helpers.isLogged, (req, res) => {
...
app.post('/updateInfoShipmentArtist',helpers.isLogged, (req, res) => {
