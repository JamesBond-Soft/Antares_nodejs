...
module.exports = (app, passport) => {
    ...
    app.get('/buyers-shipping-pending',helpers.isLogged, (req, res) => {
        
        res.render('buyers/buyers-shipping-pending',{
    ...
    app.post('/getBuyerShippingPendingList',helpers.isLogged,(req, res) => {
        ...
        artworkModel.getBuyerShippingPendingList((err,data) => {
            if(err){
                console.log(err);
                res.send(JSON.stringify({status:false, msg: err})); 
            }else{
                artworkModel.getBuyerShippingPendingListCount((err,numberData) => {
                    if(err){
                        res.send(JSON.stringify({status:false, msg: err})); 
                        console.log(err);
                    }else{
