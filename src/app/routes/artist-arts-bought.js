...
module.exports = (app, passport) => {
        ...
        app.get('/artist-arts-bought',helpers.isLogged, (req, res) => {
            
            res.render('artist/artist-arts-bought',{
        ...
        app.post('/getArtistArtsBoughtList',helpers.isLogged,(req, res) => {
            ...
            artworkModel.getArtistArtsBoughtList((err,data) => {
                if(err){
                    console.log(err);
                    res.send(JSON.stringify({status:false, msg: err})); 
                }else{
                    artworkModel.getArtistArtsBoughtListCount((err,numberData) => {
                        if(err){
                            res.send(JSON.stringify({status:false, msg: err})); 
                            console.log(err);
                        }else{
